...
open class SCLAlertView: UIViewController {
    ...
    fileprivate func setup() {
        ...
        // Circle View
        circleBG.backgroundColor = LIGHT_BLUE_COLOR
        ...
        // Colours
        contentView.backgroundColor = DARK_BLUE_COLOR
        viewText.backgroundColor = DARK_BLUE_COLOR
        labelTitle.textColor = WHITE_COLOR
        viewText.textColor = WHITE_COLOR
        contentView.layer.borderColor = LIGHT_BLUE_COLOR.cgColor
