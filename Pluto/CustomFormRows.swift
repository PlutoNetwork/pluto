//
//  CustomFormRows.swift
//  Pluto
//
//  Created by Faisal M. Lalani on 7/6/17.
...
public class MapViewController : UIViewController, TypedRowControllerType, MKMapViewDelegate {
    ...
    func updateTitle(){
        ...
        LocationService.sharedInstance.convertCoordinatesToAddress(latitude: mapView.centerCoordinate.latitude, longitude: mapView.centerCoordinate.longitude) { (address) in
